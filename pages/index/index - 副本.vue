<template>
	<view :data-theme='theme()' class="yanse">
		<view class="top_head pr">
			...
			<view style="display: flex;align-items: center;background-color: #ffffff; border: 1rpx solid #588BC8;border-radius: 40rpx;margin: 30rpx 20rpx; width: 600rpx;">
				<!-- <view style="width: 80rpx;font-size: 35rpx;margin-bottom: 10rpx;color: #FFF;margin-left: 50rpx;">全国</view> -->
				<view class="top_search special" @click="showSearch=true" style="display: flex;justify-content:space-between;">
					<view>
						<text class="icon iconfont icon-sousuo"></text>
						<text>iPhone 14 Pro Max</text>
					</view>
					<view style="color:#588BC8;">
						<text> | 搜索</text>
					</view>
			...
			<!-- <view @click="dingyue()" style="margin-top: 46rpx;">订阅</view> -->
			</view>
