<template>
	<view>
		...
		<template v-if="diyItems[0].type==='banner'&&diyItems[0].data!=null">
			<!-- <banner :<strong>itemData</strong>="diyItems[0]"></banner> -->
		...
		<!-- 手机分类 -->
		<view v-show="type != 1" :class="[ 'mobilefl','bom']" style="width: 100%;height: 326rpx;margin-top: 20rpx;">
			...
			<!--单组图-->
			<template v-if="diyItems[7].type==='imageSingle'&&diyItems[7].data!=null">
				<imagesingle :itemData="diyItems[7]"></imagesingle>
			</template>

			<!--商品组-->
			<template v-if="diyItems[8].type==='product'&&diyItems[8].data!=null">
				<product :itemData="diyItems[8]"></product>
			</template>
				
			<!--单组图-->
			<template v-if="diyItems[9].type==='imageSingle'&&diyItems[9].data!=null">
				<imagesingle :itemData="diyItems[9]"></imagesingle>
			</template>

			<!--商品组-->
			<template v-if="diyItems[10].type==='product'&&diyItems[10].data!=null">
				<product :itemData="diyItems[10]"></product>
			</template>

			<!--单组图-->
			<template v-if="diyItems[11].type==='imageSingle'&&diyItems[11].data!=null">
				<imagesingle :itemData="diyItems[11]"></imagesingle>
			</template>

			<!--商品组-->
			<template v-if="diyItems[12].type==='product'&&diyItems[12].data!=null">
				<product :itemData="diyItems[12]"></product>
			</template>

			<!-- <block v-if="diyItems == ''"> -->
			<!--单组图-->
			<template v-if="diyItems[13].type==='imageSingle'&&diyItems[13].data!=null">
				<imagesingle :itemData="diyItems[13]"></imagesingle>
			</template>

			<!--商品组-->
			<template v-if="diyItems[14].type==='product'&&diyItems[14].data!=null">
				<product :itemData="diyItems[14]"></product>
			</template>

			<!--单组图-->
			<template v-if="diyItems[15].type==='imageSingle'&&diyItems[15].data!=null">
				<imagesingle :itemData="diyItems[15]"></imagesingle>
			</template>

			<!--商品组-->
			<template v-if="diyItems[16].type==='product'&&diyItems[16].data!=null">
				<product :itemData="diyItems[16]"></product>
			</template>

			<!--单组图-->
			<template v-if="diyItems[17].type==='imageSingle'&&diyItems[17].data!=null">
				<imagesingle :itemData="diyItems[17]"></imagesingle>
			</template>
